...
export default async function EditProductPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [{ data: product }, { data: variants }, { data: families }, { data: allergens }, { data: links }, { data: days }, { data: ingredientLinks }, { data: attributeLinks }] = await Promise.all([
