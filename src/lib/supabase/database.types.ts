...
export interface Database {
  public: {
    ...
    Functions: {
      ...
      check_variant_order_limit: { Args: { p_product_variant_id: string; p_pickup_point_id: string; p_collection_date: string }; Returns: { is_available: boolean; reason: string; max_quantity: number }[] };
